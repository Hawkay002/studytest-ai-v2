...
const FOCUS_LABEL: Record<StudyFocus, string> = {
  concepts: "core concepts and how they fit together",
  definitions: "precise definitions of key terms",
  dates: "important dates and chronological order",
  cause_effect: "cause-and-effect relationships",
  application: "real-world application and worked examples",
  critical_analysis: "critical analysis and evaluation of arguments",
  synthesis: "synthesis of information from multiple sources",
  mixed: "a balanced mix of all the above",
}

const DIFFICULTY_LABEL: Record<Difficulty, string> = {
  easy: "easy (recall / direct recognition)",
  medium: "medium (some synthesis required)",
  hard: "extremely challenging (deep conceptual synthesis, creative application, and integration of multiple sub-topics; requires deep subject mastery)",
